...
type SeiWasmMessage struct {
	...
	EthereumMsg  json.RawMessage `json:"ethereum_msg,omitempty"`
}
...
func (m *CustomMessenger) DispatchCustomMsg(
	...
	case parsedMessage.EthereumMsg != nil:
		sdkMsgs, err = evmwasm.EncodeEthereumMsg(ctx, m.accountKeeper, parsedMessage.EthereumMsg, contractAddr)
	default:
