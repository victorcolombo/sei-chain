...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/sei-protocol/sei-cosmos v0.2.14-tonytest
	github.com/cosmos/iavl => github.com/sei-protocol/sei-iavl v0.1.3-tonytest4
