...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/sei-protocol/sei-cosmos v0.2.41
	...
	github.com/tendermint/tendermint => github.com/sei-protocol/sei-tendermint v0.2.20
