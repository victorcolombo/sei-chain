...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/sei-protocol/sei-cosmos v0.2.15-0.20230412184915-62f71001125a
	github.com/cosmos/iavl => github.com/sei-protocol/sei-iavl v0.1.4-0.20230412184714-468808355f33
