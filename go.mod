...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/sei-protocol/sei-cosmos v0.2.1-race-cond-2
	github.com/cosmos/iavl => github.com/sei-protocol/sei-iavl v0.1.2-node-locks
